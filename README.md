...
| **CSS_FILE_NAME**                                       | `stylelint.config.mjs`                                                       | Filename for [Stylelint configuration](https://github.com/stylelint/stylelint)                                                                                                                                                                                                                                                                                              |
...
| **UPDATE_EXISTING_GITHUB_PULL_REQUEST_SUMMARY_COMMENT** | `true`                                                                       | If set to `true`, Super-linter will update an existing pull request summary comment instead of creating a new one on each run. Only applies when `ENABLE_GITHUB_PULL_REQUEST_SUMMARY_COMMENT` is set to `true`.                                                                                                                                                             |
