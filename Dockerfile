...
#########################################
FROM alpine/terragrunt:1.14.9 AS terragrunt
...
FROM hashicorp/terraform:1.15.0 AS terraform
...
FROM dart:3.11.5-sdk AS dart
FROM mcr.microsoft.com/dotnet/sdk:10.0.203-alpine3.23 AS dotnet-sdk
